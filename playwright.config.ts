...
const selectedStandaloneCommand = (process.env.E2E_NONTERMINAL_HORIZON === '1' || process.env.E2E_TRENDS_UNPUBLISHED === '1' || process.env.E2E_MARKET_READINESS === '1' || process.env.E2E_MARKET_HISTORY === '1')
