...
function ManageTournamentClient({ params }: { params: { id: string } }) {
  ...
  const { register, handleSubmit, formState: { errors } } = useForm<FormData>({
    ...
    defaultValues: {
      ...
      managerId: mockTournamentData.managerId,
  ...
  return (
    <RootLayout>
      <div className="container max-w-4xl mx-auto px-4 py-8">
        <div className="mb-6">
          <Link href={`/tournament/${tournamentId}`} className="flex items-center text-primary hover:underline mb-4">
        ...
        <Card className="p-6 mb-8">
          ...
          <Alert className="mb-6 bg-blue-50 border-blue-200">
            ...
            <AlertDescription className="text-blue-800">
              You can edit basic tournament details below. To change tournament structure or format, you'll need to create a new tournament.
            </AlertDescription>
          </Alert>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="space-y-6">
              ...
              <div className="grid gap-3">
                <Label htmlFor="manager-id">Manager ID <span className="text-red-500">*</span></Label>
                <Input 
                  id="manager-id"
                  {...register("managerId")}
                />
              ...
              <div className="grid gap-3">
                <Label htmlFor="manager-name">Manager Name <span className="text-red-500">*</span></Label>
                <Input 
                  id="manager-name"
        ...
        <Card className="p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-sm font-medium text-muted-foreground mb-2">Tournament Details</h3>
            ...
            <div>
              <h3 className="text-sm font-medium text-muted-foreground mb-2">Tournament Structure</h3>
              <dl className="space-y-2">
                <div className="flex justify-between">
                  <dt className="font-medium">Group Stage:</dt>
                  <dd>{mockTournamentData.groupFormat === "none" ? "No" : "Yes - Points Based"}</dd>
                </div>
                <div className="flex justify-between">
                  <dt className="font-medium">Knockout Stage:</dt>
                  <dd>{mockTournamentData.knockoutFormat === "none" ? "No" : "Yes - Single Elimination"}</dd>
                </div>
                <div className="flex justify-between">
          ...
          <Alert className="mt-6 bg-amber-50 border-amber-200">
            ...
            <AlertDescription className="text-amber-800">
              <strong>Note:</strong> Tournament structure settings cannot be changed. To modify group or knockout settings, you must create a new tournament.
            </AlertDescription>
          </Alert>
        </Card>
        ...
        <Card className="p-6 mb-8 border-red-200">
          ...
          <div className="bg-red-50 p-4 rounded-lg mb-6">
            <div className="flex gap-3">
              ...
              <div>
                <h3 className="font-medium text-red-800 mb-1">Delete Tournament</h3>
                <p className="text-red-700 text-sm">
                  This action cannot be undone. This will permanently delete the tournament,
                  its participants, matches, and all related data.
                </p>
              </div>
            </div>
          </div>
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    This action cannot be undone. This will permanently delete the tournament
                    "{mockTournamentData.name}" and remove all associated data from our servers.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
