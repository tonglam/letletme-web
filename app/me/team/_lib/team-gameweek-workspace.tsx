...
export interface TeamGameweekWorkspaceValue {
...
const TeamGameweekWorkspaceContext =
	createContext<TeamGameweekWorkspaceValue | null>(null)
...
export function TeamGameweekWorkspaceProvider({
	maxGw,
	initialGameweek,
	onActiveGameweekChange,
	children,
	...
	const value = useMemo<TeamGameweekWorkspaceValue>(
		() => ({
			openGameweeks,
			activeGameweek,
			openGameweek,
	...
	return (
		<TeamGameweekWorkspaceContext.Provider value={value}>
			{children}
		</TeamGameweekWorkspaceContext.Provider>
	)
}

export function useTeamGameweekWorkspace(): TeamGameweekWorkspaceValue {
	const ctx = useContext(TeamGameweekWorkspaceContext)
	if (!ctx) {
		throw new Error(
			'useTeamGameweekWorkspace must be used within TeamGameweekWorkspaceProvider',
		)
	}
	return ctx
}

export function useTeamGameweekWorkspaceOptional(): TeamGameweekWorkspaceValue | null {
	return useContext(TeamGameweekWorkspaceContext)
}
