...
| **新闻 / News** | 俱乐部和球员最近发生了什么？ | 转会、俱乐部公告、记者消息、球队动态、伤停和赛前信息 | `NEWS` Story 的编辑集合 | 日内持续更新；更正优先于新增 |
| **观点 / Views** | 可信的记者、分析者和 KOL 在怎么判断？ | X、YouTube、播客中的具名观点、模板、差异和反对意见 | `OPINION` Story 的编辑集合 | 强归因；不生成“社区共识” |
| **深度 / Features** | 哪些长文章、节目或分析值得花时间？ | 球队分析文章、专题、播客/视频的许可摘要和编辑重组 | `FEATURE` Story 的编辑集合 | 低频、长生命周期、权利审查更严格 |
