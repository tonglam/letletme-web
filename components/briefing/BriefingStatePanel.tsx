...
export async function BriefingStatePanel({
	...
	const resolved: BriefingState = isBriefingState(state) ? state : 'UNAVAILABLE'
	const Icon = stateIcon[resolved]
	const key = resolved.toLowerCase() as Lowercase<BriefingState>
